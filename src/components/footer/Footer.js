    ...
    return (
        <div className='col mt-4 d-flex justify-content-left'>
            ...
            <div className='col-2 d-inline-block'>
                <p style={{ textAlign: 'left' ,marginLeft: '10px'}}><b>ONLINE SHOPPING</b></p>
                <p style={{ textAlign: 'left', marginBottom: '-1px' ,marginLeft:'10px'}} className='text-secondary'>Men</p>
                <p style={{ textAlign: 'left', marginBottom: '-1px' ,marginLeft:'10px'}} className='text-secondary'>Women</p>
                <p style={{ textAlign: 'left', marginBottom: '-1px' ,marginLeft:'10px'}} className='text-secondary'>Kids</p>
                <p style={{ textAlign: 'left', marginBottom: '-1px' ,marginLeft:'10px'}} className='text-secondary'>Home & Living</p>
                <p style={{ textAlign: 'left', marginBottom: '-1px' ,marginLeft:'10px'}} className='text-secondary'>Beauty</p>
            </div>

            <div className='col-2 d-inline-block' style={{marginLeft:'8px'}}>
